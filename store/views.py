...
from .forms import ProductForm, FeedbackForm, ContactFeedbackForm, CheckoutForm 
from .models import Product, Category, Cart, Order, OrderItem, SubCategory, Feedback, ContactFeedback, ShippingAddress
...
#     # Sirf cancelled order hi delete ho
#     if order.status == "cancelled":
#         order.delete()
